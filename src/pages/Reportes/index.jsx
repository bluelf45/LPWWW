...
export default function Inventario() {
	...
	useMemo(() => {
		...
		setTickets(final);
	}, [ticketsSolicitados, startDate, endDate, sortOrder]);
					...
					{(() => {
						switch (selectedOption) {
							case 'stock':
								...
								return <ReportTableTicketEspeciales data={ticketEspecial} sort={sortOrder} />;
							case 'solicitados':
								if (!masSolicitados) return <p>Cargando...</p>;
								return <ReportTableSolicitados data={masSolicitados} sort={sortOrder} />;
							case 'devoluciones':
								if (!atrasados) return <p>Cargando...</p>;
								return <ReportTableDevoluciones data={atrasados} sort={sortOrder} />;
							case 'tickets':
								if (!tickets) return <p>Cargando...</p>;
								return <ReportTableTickets data={tickets} sort={sortOrder} />;
							default:
